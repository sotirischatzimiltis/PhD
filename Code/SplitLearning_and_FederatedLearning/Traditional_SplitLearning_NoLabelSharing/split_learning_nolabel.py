...
from models_nolabel import LeNetClientNetwork, LeNetServerNetwork
...
# Script aborts if more than 10 clients are participating
if MAX_RANK > 10:
...
if worker:
    ...
    val_loss = 0.0
    total_n_labels_test, total_n_labels_train = 0, 0
    ...
    file_path = "C:/Users/sc02449/OneDrive - University of Surrey/Desktop/Code/Split-Learning-and-Federated-Learning-master/src/fashion_mnist.pkl"
    if os.path.isfile(file_path):
        ...
        if rank == 1:
            ...
            # Save the train_set list using pickle so every client can access it
            train_set = []
    ...
    while True:
        ...
        if msg == "you_can_start":
            ...
            for batch_idx, (inputs, labels) in enumerate(train_set):
                ...
                # Send to the server the gradient from the output layer 
            ...
            if rank == MAX_RANK:
                ...
                for batch_idx, (inputs, labels) in enumerate(test_loader):
                    ...
                    comm.send(["metrics",[total_n_labels_test,correct_test,val_loss]],dest=SERVER)
...
# Define the procedure for the server
    ...
    while(True):
        ...
        if msg[0] == "tensor":
            ...
            # Dereference the input tensor from message
            input_tensor = msg[1]
            # Obtain outputs from fully connected layer forward pass
            ...
            if phase == "train":
                ...
                # Receive gradient from fully connected layer
            ...
            if phase == "validation":
                ...
                # Add current label count to the total number of labels
                message = comm.recv(source = active_worker)
                total_n_labels_test,correct_test,val_loss = message[1]
