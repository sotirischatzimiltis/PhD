...
"""models_nolabel.py Contains an implementation of the LeNet5 model
    Initial code written by Xenia Ioannidou and Bas Straathof
"""

__author__ = "Sotiris Chatzimiltis"
...
class LeNetClientNetwork(nn.Module):
    ...
    def fc_forward(self,x):
        """
        Defines forward pass of the final fully connected layer.
        Parameters
        ----------
        x : Activations from previous FC layer.
        Returns
        -------
        x : Final Output
        """
